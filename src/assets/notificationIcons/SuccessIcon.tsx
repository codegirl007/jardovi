...
export const SuccessIcon = () => {
  return (
    ...
    >
      ...
      <g clipPath="url(#clip0_4944_371104)">
        <path
          d="M15.25 19L17.75 21.5L22.75 16.5M27.3333 19C27.3333 23.6023 23.6023 27.3333 19 27.3333C14.3976 27.3333 10.6666 23.6023 10.6666 19C10.6666 14.3976 14.3976 10.6666 19 10.6666C23.6023 10.6666 27.3333 14.3976 27.3333 19Z"
          stroke="#079455"
          strokeWidth="1.66667"
          strokeLinecap="round"
